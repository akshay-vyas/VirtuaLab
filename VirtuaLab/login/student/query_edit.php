...
<form name="form1" method="post" action="query_update.php" id="formID">
  ...
  <input type="hidden" name="q_id" id="q_id" value="<?php echo $row['q_id'];?>">
    <tr>
      <td>Q From </td>
      <td><input type="text" name="q_from" id="q_from" class="validate[required,custom[onlyLetter]]" value="<?php echo $row['q_from'];?>"></td>
    </tr>
    <tr>
      <td>Q To </td>
    ...
    <tr>
      <td>Query Desc </td>
      <td><p>
        <input name="query_desc" type="text" class="validate[required,custom[onlyLetter]]" id="query_desc" value="<?php echo $row['query_desc'];?>">
      </p>
        <p>&nbsp;        </p></td>
    </tr>
    <tr>
	<td>Reply</td>
      <td><p>
        <input name="reply" type="text" class="validate[required,custom[onlyLetter]]" id="reply" value="<?php echo $row['reply'];?>" readonly="">
      </p>
        <p>&nbsp;        </p></td>
    </tr>
    <tr>
