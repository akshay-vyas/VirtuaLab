...
<form name="form1" method="post" action="user_reg_insert.php" id="formID">
  <table width="303">
    ...
    <tr>
      <td>E-Mail </td>
      <td><input type="text" name="eh" class="validate[required,custom[email]]"></td>
    </tr>
    <tr>
      <td>Mobile No</td>
      <td><input type="text" name="ei" id="ei" class="validate[required,custom[mobile]]"></td>
    </tr>
    <tr>
      <td>Age</td>
      <td><input type="text" name="ej" class="validate[required,custom[onlyNumber]]"></td>
    </tr>
    <tr>
      <td>Gender</td>
      <td><input name="ek" type="radio" value="Male">
	    ...
	    <tr>
      <td>Qualification</td>
      <td><input type="text" name="el" class="validate[required]"></td>
    </tr>
    <tr>
