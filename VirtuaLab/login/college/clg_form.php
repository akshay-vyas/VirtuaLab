...
<form name="form1" method="post" action="clg_insert.php" id="formID">
  <table width="685" height="263" align="center" id="bc">
    <tr>
      ...
      <td width="443"><input type="text" name="ba" class="validate[required,custom[onlyLetter]]"></td>
    </tr>
    <tr>
      ...
      <td><input type="text" name="bc" class="validate[required,custom[onlyLetter]]"></td>
    </tr>
    <tr>
